...
# ASCII Banner
echo -e "\e[33m        _ _             _____ _ _        ___ _         _____ \e[0m"
echo -e "\e[33m  /\/\ (_) | ___ __ ___/__   (_) | __   / __\ |__  _ _|___  |\e[0m"
echo -e "\e[33m /    \| | |/ / '__/ _ \ / /\/ | |/ /  / /  | '_ \| '__| / / \e[0m"
echo -e "\e[33m/ /\/\ \ |   <| | | (_) / /  | |   < _/ /___| | | | |   / /  \e[0m"
echo -e "\e[33m\/    \/_|_|\_\_|  \___/\/   |_|_|\_(_)____/|_| |_|_|  /_/   \e[0m"
echo -e "\e[33m                                                            \e[0m"
...
echo -e "\e[32mInstallasi BERES. Server VPS harus di REBOOT, lalu akses seperti biasa menggunakan Winbox, user admin & password kosong.\e[0m" # Green color